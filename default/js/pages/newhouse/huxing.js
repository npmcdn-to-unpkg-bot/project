   ...
   buildList : function(data, box){
        ...
        $.each(data, function(k, v){
            ...
            temp += '<li class="ui-border-t">'
                +  '<a href="/newhouse/'+v.pid+'/huxing/'+v.housetypeId+'.html"><div class="hf-house-box">'
                +  '<div class="ui-list-img">'
                +  '<img class="lazyload ui-list-img-s" src="STATIC_JS/lazyLoad/loading.png" data-original="'+v.photoPath+'" alt="">'
                +  '</div>'
                +  '<div class="ui-list-info">'
                +  '<h4 class="ui-nowrap" >'+v.title+' '
				+  '</h4>'
				+  '<div class="hf-f12 hf-badge-wrap" style="height:35px;">参考总价'
                +  '<span class="hf-f15 hf-badge-pos hf-fred">'+v.totalPrice+'万元</span></div>'
                +  ' <div class="ui-nowrap hf-f12 hf-fgray">'+v.typename+'  '+v.typeArea+'</div>'
                +  '</div></div></a></li>';
			}else{
			temp += '<li class="ui-border-t">'
                +  '<a href="/newhouse/'+v.pid+'/huxing/'+v.housetypeId+'.html"><div class="hf-house-box">'
                ...
                +  '<div class="ui-list-info">'
                +  '<h4 class="ui-nowrap" >'+v.title+' '
				+  '<i class="hf-badge-blue">'+v.saleState+'</i></h4>'
				+  '<div class="hf-f12 hf-badge-wrap" style="height:35px;">参考总价'
                +  '<span class="hf-f15 hf-badge-pos hf-fred">'+v.totalPrice+'万元</span></div>'
                +  ' <div class="ui-nowrap hf-f12 hf-fgray">'+v.typename+'  '+v.typeArea+'</div>'
                +  '</div></div></a></li>';	
...
$(function(){
  ...
  window.onscroll = throttle(function(){
      loadMore.init("/Newhouse/Huxing/getmorehuxing", "#loading", "#listBox");
  }, 300);

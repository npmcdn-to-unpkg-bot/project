   ...
   buildList : function(data, box){
        ...
        $.each(data, function(k, v){
            temp += '<li class="ui-border-t house-sales-list">'
                ...
                +  '<a href="'+v.url+'zufang/'+v.aid+'/"><img src="'+v.housephoto+'" /></a>'
                +  '</div>'
                +  '<div class="ui-list-info">'
                +  '<h4 class="ui-nowrap-multi hf-nowrap-multi"><a href="'+v.url+'zufang/'+v.aid+'/">'+v.hiretitle+'</a></h4>'
                +  '<a href="'+v.url+'zufang/'+v.aid+'/">'
                ...
                +  '</div>'
                +  '</div>'
                +  '<div class="hf-contorls" style="display:none;"><div class="hf-contorls-wrap"><span><a href="/member/favorite/edit?all=1&type=3&mId='+v.aid+'">删除</a></span><span><a href="/member/favorite/edit?all=2&type=3&uId='+v.uId+'">清空</a></span><i></i></div></div>'
                +  '</li>';
        });
